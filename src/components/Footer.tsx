...
export function Footer({ content }: FooterProps) {
  return (
    <footer className="h-[150px] bg-ink px-0 pb-0 xl:h-[317px] xl:px-0 xl:pb-0">
      <div className="relative mx-auto h-full w-[calc(100%-64px)] max-w-[329px] border-t border-electric/50 sm:max-w-[620px] lg:max-w-[700px] xl:max-w-[1320px]" data-aos="content-reveal-up">
