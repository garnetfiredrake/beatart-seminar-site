...
export function AccessButton({ label, href = "#notice" }: AccessButtonProps) {
  return (
    ...
    >
      ...
      <span className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-[9px] bg-ink px-8 transition-colors duration-500 ease-out group-hover:bg-[#03131C] sm:rounded-[12px] xl:rounded-[16px]">
        ...
        <span className="absolute -inset-y-7 -left-1/2 w-1/3 -skew-x-[20deg] bg-white/55 blur-[5px] opacity-0 transition-all duration-700 ease-out group-hover:left-[120%] group-hover:opacity-75" />
